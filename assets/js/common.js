...
function buildSidebar(activePage) {
  var navItems = [
    ...
    { id: 'formation-comparison', label: 'Formation Compare', href: 'formation-comparison.html', icon: ICONS.barChart },
    ...
    { id: 'scale-risk', label: 'Scale Risk', href: 'scale-risk.html', icon: ICONS.shield },
